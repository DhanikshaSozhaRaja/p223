...
if not zipf:
    print("The zipped folder is not password protected! You can successfully open it :)")
else:
    starttime = time.time()
    ...
    for i in range(len(words)):
        ...
        if(result ==0):
            ...
            print("Sorry, password not found :( . A total of "+str(c)+ " possible combinations tried in "+str(duration)+" seconds. Password is not of four characters!")
        else:
            duration = endtime = starttime
